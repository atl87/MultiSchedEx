...
${OBJECTDIR}/fps_schedulers.o: fps_schedulers.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fps_schedulers.o fps_schedulers.cpp

${OBJECTDIR}/fps_tests.o: fps_tests.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fps_tests.o fps_tests.cpp
...
${OBJECTDIR}/utility_functions.o: utility_functions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility_functions.o utility_functions.cpp
